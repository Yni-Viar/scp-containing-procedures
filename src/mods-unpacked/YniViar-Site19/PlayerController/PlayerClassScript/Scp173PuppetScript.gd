...
## Set face on spawn
func set_face():
	var tex: ShaderMaterial = load("res://mods-unpacked/YniViar-Site19/Assets/Materials/scp173.tres")
	tex.set_shader_parameter("albedo_b", load("res://mods-unpacked/YniViar-Site19/Assets/ExternalModels/scp173/Faces/face_" + str(rng.randi_range(1, faces)) + ".png"))
